...
<head>
    ...
    <title>TMS Therapy in Palm Springs | Karma TMS PC</title>
...
<body>
    ...
    <!-- Hero Section -->
    <section class="pt-32 pb-16 bg-gradient-to-r from-purple-100 to-violet-100 px-4">
        <div class="container mx-auto">
            <div class="flex flex-col lg:flex-row items-center gap-12">
                <div class="lg:w-1/2 text-center fade-in-up">
                    <span
                        class="badge badge-purple mb-4 bg-gradient-to-r from-primary-brand to-purple-600 text-white border-0 mx-auto"
                        style="color:white">
                    ...
                    <div class="flex flex-row gap-4 justify-center flex-wrap">
                        <a href="contact-us.php"
                            class="btn bg-gradient-to-r from-primary-brand to-purple-600 text-white hover:from-purple-700 hover:to-primary-brand px-6 py-3 rounded-md flex items-center justify-center transition-all shadow-lg hover:shadow-xl whitespace-nowrap">
                            Schedule Consultation
                            <i data-lucide="arrow-right" class="ml-2 w-5 h-5"></i>
                        </a>
                        <a href="tms-quiz.php"
                            class="btn bg-white border-2 border-primary-brand text-primary-brand hover:bg-primary-brand hover:text-white px-6 py-3 rounded-md flex items-center justify-center transition-all whitespace-nowrap">
                            Take TMS Quiz
                        </a>
                    </div>
                </div>
    ...
    <section class="py-16 px-4 bg-white">
        <div class="container mx-auto">
            ...
            <div id="indications-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Injected via JS -->
            </div>
        </div>
    </section>
    ...
    <section class="py-16 px-4 bg-gray-50">
        <div class="container mx-auto max-w-6xl">
            <div class="text-center mb-12 fade-in-up">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Real experiences from patients who found lasting relief through TMS Therapy.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 fade-in-up" style="position: relative;">
                    ...
                    <p class="text-gray-700 italic mb-6 leading-relaxed">"After struggling with depression for years, TMS therapy finally gave me my life back. The sessions were easy and the staff was incredible."</p>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 fade-in-up" style="position: relative;">
                    ...
                    <p class="text-gray-700 italic mb-6 leading-relaxed">"I was skeptical at first, but by week three of my TMS treatment, the heavy fog had lifted. I haven't felt this clear-headed in a decade."</p>
                    <div class="flex items-center gap-4">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 fade-in-up" style="position: relative;">
                    ...
                    <p class="text-gray-700 italic mb-6 leading-relaxed">"TMS changed everything for me. It was painless, non-invasive, and honestly, the best decision I've made for my mental health."</p>
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Coachella Valley, CA</p>
                        </div>
                    </div>
                </div>
            </div>
