...
class KarmaComponents {
  ...
  async init() {
    ...
    if (this.headerPlaceholder) {
      promises.push(
        this.loadComponent("includes/header.html", this.headerPlaceholder),
      );
    }
    if (this.footerPlaceholder) {
      promises.push(
        this.loadComponent("includes/footer.html", this.footerPlaceholder),
      );
    }
...
function initTestimonials() {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      quote:
        "Depression is a miserable way to deal with life on a daily basis. When the meds don't seem to do the trick, TMS therapy is a sensible addition to treatment that has helped me in the battle.",
    },
    {
      name: "Luis",
      ...
      rating: 5,
      quote:
        "The comprehensive care I received at Karma TMS was exceptional. The staff made me feel comfortable and supported throughout my journey.",
    },
    {
      name: "Lucia",
      ...
      rating: 5,
      quote:
        "TMS therapy has given me hope again. I can finally envision a future free from the weight of my symptoms.",
    },
    {
      name: "Thomas M.",
      ...
      rating: 5,
      quote:
        "After years of struggling, Karma TMS offered me a treatment that actually works. I'm grateful every single day.",
    },
    {
      name: "Benjamin A.",
      ...
      rating: 5,
      quote:
        "The professional approach and cutting-edge technology at Karma TMS made all the difference in my recovery journey.",
    },
    {
      name: "Nicole J.",
      ...
      rating: 5,
      quote:
        "I was skeptical at first, but the results speak for themselves. TMS therapy transformed my life in ways I never thought possible.",
    },
    {
      name: "Lynette I.",
      ...
      rating: 5,
      quote:
        "The compassionate team at Karma TMS guided me through every step. I finally feel like myself again after years of struggle.",
    },
  ];
  ...
  window.updateTestimonialReact = function () {
    ...
    setTimeout(() => {
      ...
      if (thumbnailsContainer) {
        document
          .querySelectorAll(".testimonial-thumb-react")
          .forEach((thumb, index) => {
...
function initTeamPage() {
  ...
  const teamMembers = [
    // ===================== Medical Staff =====================
    {
      ...
      category: "medical",
      image:
        "images/team/dr-sundar-new.webp",
    ...
    },
    {
      ...
      credentials: [
        ...
        "Master Psychopharmacology Certificate",
      ],
    ...
    // },
    {
      ...
      education:
        "Kansas State University, Wichita State University (cum laude)",
      location: "Palm Springs, CA",
    },
    {
      id: "punit-patel",
    ...
    //   education:
    //     "USC (Neuroscience & Biological Sciences), Touro University California (PA & MPH)",
    //   location: "Palm Springs, CA",
    // },
    // {
    //   id: "shivali-dave",
    ...
    },
    {
      ...
      education:
        "California State University, Long Beach (Healthcare Administration)",
      location: "Palm Springs, CA",
    },
    {
      id: "vipul-reddy",
  ...
  function renderFilters() {
    ...
    const filtersConfig = [
      ...
      },
      {
        ...
        icon: "stethoscope",
        get count() {
          return teamMembers.filter((m) => m.category === "medical").length;
        },
      },
      {
        key: "administrative",
        label: "TMS Technologists",
        icon: "zap",
        get count() {
          return teamMembers.filter((m) => m.category === "administrative")
            .length;
        },
      },
    ];
    ...
    filtersConfig.forEach((filter) => {
      ...
      else if (filter.key === "administrative")
  ...
  function createMemberCard(member, index) {
    ...
    const credentialsHtml = member.credentials
      .slice(0, 2)
      .map((c) => `<span class="credential-tag">${c}</span>`)
      .join("");
    const moreCredentials =
      member.credentials.length > 2
        ? `<span class="credential-more">+${member.credentials.length - 2} more</span>`
        : "";
  ...
  const fdaIndications = [
    {
      ...
      icon: "brain",
      description:
        "Treatment-resistant depression after 1+ medication failures",
    },
    {
      ...
      icon: "trending-up",
      description:
        "For patients who haven't responded to traditional treatments",
    },
    {
  ...
  const sessionSteps = [
    {
      ...
      duration: "45 minutes",
      description:
        "Precise targeting using advanced qEEG technology to map your unique brain patterns and identify optimal stimulation sites.",
      icon: "brain",
      details: [
    ...
    },
    {
      ...
      duration: "20 minutes",
      description:
        "Non-invasive magnetic pulses delivered to specific brain regions while you relax comfortably in our treatment chair.",
      icon: "star",
      details: [
    ...
    },
    {
      ...
      duration: "10 minutes",
      description:
        "Regular assessments to monitor your improvement and adjust treatment protocols for optimal results.",
      icon: "trending-up",
      details: [
  ...
  const safetyFAQs = [
    {
      ...
      answer:
        "Yes, TMS is FDA-cleared and has been used safely since 2008. The most common side effect is mild scalp discomfort during treatment, which typically diminishes over time. Unlike medications, TMS has no systemic side effects and doesn't affect memory or cognition.",
    },
    {
      question: "Who is not eligible for TMS?",
      answer:
        "Patients with metallic implants near the head (like cochlear implants, deep brain stimulators, or aneurysm clips), those with a history of seizures, or patients taking medications that lower seizure threshold may not be candidates. A thorough screening ensures safety.",
    },
    {
      question: "What does TMS feel like?",
      answer:
        "Most patients describe TMS as a light tapping sensation on the scalp, similar to a woodpecker. The magnetic pulses may initially feel unusual, but patients typically adjust within the first few sessions. You remain fully awake and alert throughout treatment.",
    },
    {
      question: "How long do results last?",
      answer:
        "Clinical studies show that 68% of patients maintain their improvement at 6 months, and 45% remain in remission at 12 months. Many patients benefit from maintenance sessions to sustain their improvement long-term.",
    },
    {
      question: "Can I drive after TMS treatment?",
      answer:
        "Yes, you can drive immediately after TMS treatment. Unlike ECT, TMS doesn't affect memory, cognition, or consciousness. Most patients return to work or daily activities right after their session.",
    },
    {
      question: "Does insurance cover TMS?",
      answer:
        "Most major insurance plans, including Medicare, cover TMS therapy for treatment-resistant depression. Our insurance specialists will verify your coverage and handle pre-authorization to minimize out-of-pocket costs.",
    },
  ];
...
function initPrTMSTherapyPage() {
  ...
  const prtmsFAQs = [
    {
      question: "How is prTMS different from standard TMS?",
      answer:
        "Standard TMS uses a fixed frequency (usually 10Hz) for all patients. prTMS personalizes the frequency and location of stimulation based on your individual EEG brain map, potentially leading to more targeted results.",
    },
    {
      question: "Is perosnalized TMS covered by insurance?",
      answer:
        "Coverage varies. Standard TMS for depression is widely covered, but the personalized 'off-label' protocols of prTMS may often be an out-of-pocket expense. We provide detailed superbills for potential reimbursement.",
    },
    {
      question: "Does it hurt?",
      answer:
        "Like standard TMS, prTMS is generally well-tolerated. You may feel a tapping sensation on your scalp. Side effects are typically mild and transient, such as a slight headache.",
    },
    {
      question: "How many sessions will I need?",
      answer:
        "A typical course matches standard TMS (approx. 36 sessions), but because we adjust based on weekly EEGs, the exact number can be tailored to your progress and goals.",
    },
  ];
...
function initBlogPage() {
  ...
  let allBlogPosts = []; // Initialize empty array
  ...
  function init() {
    ...
    const localBlogData = [
      {
        ...
        date: "June 12, 2026",
        readTime: "9 min read",
        image: "images/blog/tms-therapy-pros-and-cons-thumb.webp",
        featured: false,
      ...
      },
      {
        ...
        date: "June 6, 2026",
        readTime: "8 min read",
        image: "images/blog/tms-therapy-contraindications-thumb.webp",
        featured: false,
      ...
      },
      {
        ...
        excerpt:
          "Do psychiatrists do therapy? Learn about the role of a psychiatrist, whether they offer talk therapy, and how they differ from psychologists and therapists in California.",
        category: "mental-health",
        author: "Dr. Keerthy Sunder",
        date: "May 11, 2026",
        readTime: "12 min read",
        image: "images/blog/do-psychiatrists-do-therapy-thumb.webp",
        featured: false,
      ...
      },
      {
        ...
        date: "May 5, 2026",
        readTime: "8 min read",
        image: "images/blog/mental-health-awareness-month-thumb.webp",
        featured: false,
      ...
      },
      {
        ...
        excerpt:
          "Curious about the cost of TMS therapy? We break down the factors that influence the price, from insurance coverage to treatment protocols, and why it's a valuable investment in your future.",
        category: "tms-therapy",
        author: "Dr. Keerthy Sunder",
        date: "March 20, 2026",
        readTime: "8 min read",
      ...
      },
      {
        ...
        date: "March 14, 2026",
        readTime: "10 min read",
        image: "images/blog/When Anxiety Becomes a Disorder.png",
        featured: true,
        url: "when-anxiety-becomes-a-disorder.php",
      },
      {
        id: 47,
        title: "Depression vs Burnout: How to Tell the Difference",
        excerpt:
        ...
        readTime: "11 min read",
        image:
          "images/blog/Depression vs Burnout How to Tell the Difference.png",
        featured: false,
        url: "depression-vs-burnout.php",
      },
      {
        id: 46,
        title: "Signs Your Depression Needs Professional Treatment",
        excerpt:
        ...
        date: "March 7, 2026",
        readTime: "10 min read",
        image: "images/blog/Karma blog 2.png",
        featured: false,
        url: "signs-your-depression-needs-professional-treatment.php",
      },
      {
        id: 45,
        title: "How Long Does TMS Therapy Take to Work for Depression?",
        excerpt:
        ...
        date: "March 3, 2026",
        readTime: "9 min read",
        image: "images/blog/KARMA TMS_Blog 1.png",
        featured: false,
        url: "how-long-does-tms-take-to-work-for-depression.php",
      },
      {
        id: 44,
      ...
      {
        id: 42,
        title: "Is TMS Therapy Actually Worth It? A Transparent Review",
        excerpt:
      ...
      },
      {
        ...
        featured: false,
        url: "is-tms-therapy-covered-by-insurance.php",
      },
      {
        id: 35,
        title:
      ...
      },
      {
        ...
        featured: false,
        url: "does-tms-therapy-work-for-anxiety.php",
      },
      {
        id: 32,
      ...
      },
      {
        ...
        readTime: "14 min read",
        image:
          "images/blog/understanding-ptsd-veterans-thumb.webp",
        featured: false,
      ...
      },
      {
        ...
        date: "July 13, 2026",
        readTime: "10 min read",
        image: "images/blog/can-tms-therapy-make-depression-worse-thumb.webp",
        featured: false,
      ...
      },
      {
        ...
        date: "July 5, 2026",
        readTime: "12 min read",
        image: "images/blog/what-is-tms-therapy-used-for-thumb.webp",
        featured: false,
    ...
    // For this environment, we just use local data directly to ensure visibility
    allBlogPosts = localBlogData;

    // Sorting here ensures the initial render AND the infinite scroll use the sorted order
    ...
    if (window.IntersectionObserver) {
      const observer = new IntersectionObserver(
        (entries) => {
          ...
          // Check if element is intersecting AND we have more posts AND not currently loading
      ...
      // Fallback for no IntersectionObserver support (unlikely in modern browsers but good practice)
      window.addEventListener("scroll", () => {
        if (
  ...
  function loadMorePosts() {
    ...
    setTimeout(() => {
      ...
      const nextBatch = filteredPostsCache.slice(
        currentCount,
  ...
  function renderPosts(posts) {
    posts.forEach((post, index) => {
      ...
      const link = post.url || "#"; // Modified to use URL from JSON object directly
      card.href = link;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Lucide Icons Fallback (if not handled by components)
  if (window.lucide) window.lucide.createIcons();
});
